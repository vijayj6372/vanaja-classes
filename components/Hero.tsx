    ...
    return (
        <section id="home" className="relative min-h-screen flex items-center pt-32 md:pt-40 pb-20 overflow-hidden bg-white">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
                ...
                >
                    {/* Main Visual Frame */}
                    <div className="relative z-10 p-2 sm:p-4 bg-white rounded-3xl sm:rounded-[3rem] shadow-2xl border border-slate-100 transform lg:rotate-2 max-w-sm sm:max-w-none mx-auto">
                        <div className="rounded-2xl sm:rounded-[2.5rem] overflow-hidden aspect-4/5 relative">
                            <img
