                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-16 lg:gap-20">
                    {FACULTY.map((teacher, index) => (
                        ...
                        >
                            ...
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 z-30 bg-[#0000FF] text-white px-12 py-3.5 rounded-2xl font-black text-xl shadow-[0_10px_30px_rgba(0,0,255,0.4)] border-2 border-white uppercase tracking-tight whitespace-nowrap">
                                {teacher.subject}
                            </div>
                            ...
                            <div className="border-8 sm:border-14 md:border-18 border-[#004A99] rounded-[4.5rem] md:rounded-[5.5rem] overflow-hidden bg-white shadow-2xl transition-all duration-300">
                                ...
                                <div className="p-4 md:p-6 bg-white">
                                    <div className="rounded-[3rem] md:rounded-[4rem] overflow-hidden bg-slate-50 flex justify-center items-center h-[380px] md:h-[480px] w-full relative">
                                        <img
                                ...
                                {/* Information Panel */}
                                <div className="bg-[#E31E24] pt-8 pb-12 px-8 text-center flex flex-col items-center gap-1">
                                    <h3 className="text-[#FFC600] text-3xl md:text-4xl font-black uppercase tracking-tight leading-none mb-2">
                                        {teacher.name}
                                    </h3>
                                    <p className="text-white text-xl md:text-2xl font-black uppercase tracking-widest opacity-95">
                                        {teacher.qualification}
                                    </p>

                                    {/* Experience Pill */}
                                    <div className="mt-8 bg-[#ED454B] text-[#FFC600] px-12 py-4 rounded-[2.5rem] font-black text-xl md:text-2xl border-2 border-white/10 uppercase tracking-tighter shadow-lg">
                                        {teacher.experience}
                                    </div>
                                </div>
                            </div>
